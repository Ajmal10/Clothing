...
class Admin extends CI_Controller
{
	...
	public function invoice()
	{
		...
		// $data['barang'] = $this->Mpesanan->tampilDetailPesanan();
		// $data['customer'] = $this->Mpesanan->tampilDetailCustomer();
		$data['detail_pesanan'] = $this->Mpesanan->tampilDetail();
	...
	{
		$data['judul'] = 'Detail Data Barang';
		$detail_pesanan = $this->Mpesanan->tampilDetailById($id);
		$data['total'] = $this->Mpesanan->totalPriceAndQuantity($id);
		$array = [];
		foreach ($detail_pesanan as $d) {
			$array[] = $d->nama;
		}
		$data['barang'] = implode(', ', $array);
		$this->load->view('templates/headerAdmin', $data);
