	...
	<section class="product-section">
		<div class="container">
			<div class="back-link">
				<a href="<?= base_url('');?>category"> &lt;&lt; Back to Category</a>
			</div>
			<div class="row">
				<div class="col-lg-6">
					...
					<div class="product-thumbs" tabindex="1" style="overflow: hidden; outline: none;">
						<div class="product-thumbs-track">
							<div class="pt active" data-imgbigurl="img/single-product/1.jpg"><img src="<?= base_url('assets/');?>img/single-product/thumb-1.jpg" alt=""></div>
				...
				<div class="col-lg-6 product-details">
					...
					<a href="<?= base_url('');?>troli" class="site-btn">SHOP NOW</a>
